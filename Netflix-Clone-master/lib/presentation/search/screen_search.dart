...
import 'package:netflix_clone/search_json/searchfunction.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        onChanged: (value) {
                          getImageSearch(result: value.trim());
                  ...
                  (searchControllor.text.isEmpty)
                      ...
                      : Expanded(
                          ...
                          future: getImageSearch(
                              result: searchControllor.text.trim()),
                          builder: (context, snapshot) {
